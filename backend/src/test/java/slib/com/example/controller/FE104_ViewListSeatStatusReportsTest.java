...
/**
 * Unit Tests for FE-104: View list of seat status reports
...
@DisplayName("FE-104: View list of seat status reports - Unit Tests")
class FE104_ViewListSeatStatusReportsTest {
