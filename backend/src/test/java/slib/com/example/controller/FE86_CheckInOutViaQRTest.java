...
/**
 * Unit Tests for FE-86: Check-in/Check-out library via QR code
...
@DisplayName("FE-86: Check-in/Check-out library via QR code - Unit Tests")
class FE86_CheckInOutViaQRTest {
