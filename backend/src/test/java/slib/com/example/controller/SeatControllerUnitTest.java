...
class SeatControllerUnitTest {
        ...
        void getAllSeats_validZoneId_returns200WithSeatDTOList() throws Exception {
                // Arrange
                Integer zoneId = 20;
                SeatDTO dto1 = new SeatDTO(1, "J01", SeatStatus.AVAILABLE, 1, 1, zoneId, null, null);
                SeatDTO dto2 = new SeatDTO(2, "J02", SeatStatus.BOOKED, 1, 2, zoneId, null, null);
        ...
        void getSeatsByTime_validParameters_returns200WithSeatDTOList() throws Exception {
                ...
                SeatDTO dto1 = new SeatDTO(5, "K01", SeatStatus.AVAILABLE, 1, 1, zoneId, null, null);
                SeatDTO dto2 = new SeatDTO(6, "K02", SeatStatus.HOLDING, 1, 2, zoneId, null, null);
        ...
        void getSeatsByDate_validParameters_returns200WithSeatDTOList() throws Exception {
                ...
                SeatDTO dto1 = new SeatDTO(10, "L01", SeatStatus.AVAILABLE, 1, 1, zoneId, null, null);
                SeatDTO dto2 = new SeatDTO(11, "L02", SeatStatus.BOOKED, 1, 2, zoneId, null, null);
        ...
        void getAllSeatsByArea_validParameters_returns200WithMapOfSeats() throws Exception {
                ...
                // Zone 1 seats
                SeatDTO seat1 = new SeatDTO(1, "A01", SeatStatus.AVAILABLE, 1, 1, 10, null, null);
                SeatDTO seat2 = new SeatDTO(2, "A02", SeatStatus.HOLDING, 1, 2, 10, null, null);

                // Zone 2 seats
                SeatDTO seat3 = new SeatDTO(3, "B01", SeatStatus.BOOKED, 1, 1, 20, null, null);
                SeatDTO seat4 = new SeatDTO(4, "B02", SeatStatus.AVAILABLE, 1, 2, 20, null, null);
