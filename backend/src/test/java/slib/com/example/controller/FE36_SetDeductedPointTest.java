...
/**
 * Unit Tests for FE-36: Set the deducted point for each reputation rule
...
@DisplayName("FE-36: Set the deducted point for each reputation rule - Unit Tests")
class FE36_SetDeductedPointTest {
