...
/**
 * Unit Tests for FE-46: Schedule temporary library closure and automatic reopening
 * Test Report: doc/Report/UnitTestReport/FE39_TestReport.md
 */
...
@DisplayName("FE-46: Schedule temporary library closure and automatic reopening - Unit Tests")
class FE46_ScheduleTemporaryLibraryClosureTest {
        ...
        // =========================================
        // === UTCID01: Schedule library closure - Success ===
        // =========================================

        @Test
        @DisplayName("UTCID01: Schedule library closure status with valid admin JWT returns 200 OK")
        ...
        @Test
        @DisplayName("UTCID02: Schedule library closure without token returns 500 Internal Server Error")
        ...
        @Test
        @DisplayName("UTCID03: Schedule library closure with non-admin JWT returns 403 Forbidden")
        ...
        @Test
        @DisplayName("UTCID04: Schedule library closure to same status returns 400 Bad Request")
        ...
        @Test
        @DisplayName("UTCID05: Schedule library closure with system error returns 500 Internal Server Error")
