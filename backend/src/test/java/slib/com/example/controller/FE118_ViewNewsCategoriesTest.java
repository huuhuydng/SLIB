...
/**
 * Unit Tests for FE-118: View list of news & announcements categories
...
@DisplayName("FE-118: View list of news & announcements categories - Unit Tests")
class FE118_ViewNewsCategoriesTest {
