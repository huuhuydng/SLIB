...
/**
 * Unit Tests for FE-78: View user booking details and status
...
@DisplayName("FE-78: View user booking details and status - Unit Tests")
class FE78_ViewBookingDetailsTest {
