...
/**
 * Unit Tests for FE-77: Check-in/Check-out library via QR code
 * Test Report: doc/Report/UnitTestReport/FE73_TestReport.md
 */
...
@DisplayName("FE-77: Check-in/Check-out library via QR code - Unit Tests")
class FE77_CheckInOutViaQRTest {
