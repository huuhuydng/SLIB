...
/**
 * Unit Tests for FE-109: View list of news & announcement categories
...
@DisplayName("FE-109: View list of news & announcement categories - Unit Tests")
class FE109_ViewNewsCategoriesTest {
