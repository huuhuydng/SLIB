...
/**
 * Unit Tests for FE-105: View seat status report details
...
@DisplayName("FE-105: View seat status report details - Unit Tests")
class FE105_ViewSeatStatusReportDetailsTest {
