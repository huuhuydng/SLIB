 ...
 */
@WebMvcTest(value = AreaFactoryController.class, excludeFilters = @ComponentScan.Filter(type = FilterType.ASSIGNABLE_TYPE, classes = {
...
class AreaFactoryControllerUnitTest {
        ...
        void getAll_success_returns200WithFactoriesList() throws Exception {
                // Arrange
                AreaFactoryResponse factory1 = createFactoryResponse(1L, "Table Group A", 1L, 100, 150, 200, 100,
                                "#3498db");
                AreaFactoryResponse factory2 = createFactoryResponse(2L, "Chair Set B", 1L, 300, 200, 150, 80,
                                "#e74c3c");
        ...
        void getByArea_validAreaId_returns200WithFactoriesList() throws Exception {
                // Arrange
                Long areaId = 5L;
                AreaFactoryResponse factory1 = createFactoryResponse(10L, "Desk A", areaId, 50, 100, 180, 90,
                                "#2ecc71");
                AreaFactoryResponse factory2 = createFactoryResponse(11L, "Desk B", areaId, 250, 100, 180, 90,
                                "#2ecc71");
                List<AreaFactoryResponse> factories = Arrays.asList(factory1, factory2);
        ...
        void getById_validId_returns200WithFactory() throws Exception {
                // Arrange
                Long factoryId = 15L;
                AreaFactoryResponse factory = createFactoryResponse(factoryId, "Meeting Table", 3L, 400, 300, 300, 200,
                                "#9b59b6");
        ...
        void create_validData_returns200WithCreatedFactory() throws Exception {
                // Arrange
                Long areaId = 2L;
                AreaFactoryEntity requestEntity = createFactoryEntity(null, "New Workstation", 100, 200, 160, 80,
                                "#34495e");
                AreaFactoryResponse response = createFactoryResponse(20L, "New Workstation", areaId, 100, 200, 160, 80,
                                "#34495e");
        ...
        void update_validData_returns200WithUpdatedFactory() throws Exception {
                // Arrange
                Long factoryId = 10L;
                AreaFactoryEntity requestEntity = createFactoryEntity(null, "Updated Desk", 150, 180, 200, 100,
                                "#e67e22");
                AreaFactoryResponse response = createFactoryResponse(factoryId, "Updated Desk", 5L, 150, 180, 200, 100,
                                "#e67e22");
        ...
        void update_notFound_throwsRuntimeException() throws Exception {
                // Arrange
                Long factoryId = 999L;
                AreaFactoryEntity requestEntity = createFactoryEntity(null, "Non-existent", 100, 100, 150, 100,
                                "#95a5a6");
        ...
        void drag_validCoordinates_returns200WithUpdatedPosition() throws Exception {
                ...
                Integer newX = 250;
                Integer newY = 350;
                AreaFactoryResponse response = createFactoryResponse(factoryId, "Dragged Table", 4L, newX, newY, 180,
                                90, "#16a085");
        ...
        void resize_validDimensions_returns200WithUpdatedSize() throws Exception {
                ...
                AreaFactoryResponse response = createFactoryResponse(factoryId, "Resized Chair", 6L, 100, 100, newWidth,
                                newHeight, "#c0392b");
        ...
        private AreaFactoryResponse createFactoryResponse(Long factoryId, String factoryName, Long areaId,
                        ...
                        Integer width, Integer height, Boolean isLocked) {
                return new AreaFactoryResponse(factoryId, factoryName, areaId, positionX, positionY, width, height,
                                isLocked);
        }

        // Overload for backwards compatibility with existing test calls
        private AreaFactoryResponse createFactoryResponse(Long factoryId, String factoryName, Long areaId,
                        Integer positionX, Integer positionY,
                        Integer width, Integer height, String ignored) {
                return new AreaFactoryResponse(factoryId, factoryName, areaId, positionX, positionY, width, height,
                                false);
        }
