...
/**
 * Unit Tests for FE-101: View Notification Details
...
@DisplayName("FE-101: View Notification Details - Unit Tests")
class FE101_ViewNotificationDetailsTest {
        ...
        void viewNotificationDetails_withCustomLimit_returns200() throws Exception {
                ...
                when(pushNotificationService.getUserNotifications(eq(userId), eq(10)))
                                .thenReturn(List.of(notification));
                ...
                verify(pushNotificationService, times(1)).getUserNotifications(eq(userId), eq(10));
        }
