...
/**
 * Unit Tests for FE-72: View user booking details and status
...
@DisplayName("FE-72: View user booking details and status - Unit Tests")
class FE72_ViewBookingDetailsTest {
