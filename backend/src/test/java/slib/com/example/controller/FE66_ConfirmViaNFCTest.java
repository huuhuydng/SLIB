...
/**
 * Unit Tests for FE-66: Confirm booking via NFC
...
@DisplayName("FE-66: Confirm booking via NFC - Unit Tests")
class FE66_ConfirmViaNFCTest {
        ...
        // =========================================
        // === UTCID05: Check-in outside time window ===
        // =========================================

        /**
         * UTCID05: Check-in is attempted outside the valid time window
         * Precondition: reservationId and nfc_uid are submitted from the mobile app
         * Expected: 400 Bad Request
         */
        @Test
        @DisplayName("UTCID05: Check-in outside time window returns 400 Bad Request")
        void confirmNfcUid_outsideTimeWindow_returns400() throws Exception {
                UUID reservationId = UUID.randomUUID();

                when(bookingService.confirmSeatWithNfcUid(eq(reservationId), eq("04A23C91")))
                                .thenThrow(new RuntimeException("Ngoai khung gio cho phep check-in"));
