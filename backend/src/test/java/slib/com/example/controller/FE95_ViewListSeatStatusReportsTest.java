...
/**
 * Unit Tests for FE-95: View list of seat status reports
...
@DisplayName("FE-95: View list of seat status reports - Unit Tests")
class FE95_ViewListSeatStatusReportsTest {
