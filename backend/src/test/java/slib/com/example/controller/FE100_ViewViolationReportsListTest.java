...
/**
 * Unit Tests for FE-100: View list of seat violation reports
...
@DisplayName("FE-100: View list of seat violation reports - Unit Tests")
class FE100_ViewViolationReportsListTest {
