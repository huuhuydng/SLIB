...
/**
 * Unit Tests for FE-39: Setting time for automatic check-out when time exceeds
...
@DisplayName("FE-39: Setting time for automatic check-out when time exceeds - Unit Tests")
class FE39_AutoCheckoutSettingTest {
