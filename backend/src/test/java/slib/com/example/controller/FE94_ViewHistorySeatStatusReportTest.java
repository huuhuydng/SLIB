...
/**
 * Unit Tests for FE-94: View history of sending seat status report
...
@DisplayName("FE-94: View history of sending seat status report - Unit Tests")
class FE94_ViewHistorySeatStatusReportTest {
