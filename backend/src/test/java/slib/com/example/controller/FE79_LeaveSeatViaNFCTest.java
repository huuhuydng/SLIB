...
/**
 * Unit Tests for FE-79: Leave seat via NFC after library check-in
 */
...
@DisplayName("FE-79: Leave seat via NFC after library check-in - Unit Tests")
class FE79_LeaveSeatViaNFCTest {
