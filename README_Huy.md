README_NEW.md# 🚀 SLIB - Smart Library Management System

**SLIB** là hệ thống quản lý thư viện thông minh hiện đại, hỗ trợ quản lý không gian (Area/Zone), đặt chỗ (Booking), và tích hợp AI hỗ trợ người dùng.
...
Dự án được chia làm 2 phần chính: **Backend** (Spring Boot) và **Frontend** (React + Vite).

```text
SLIB/
├── backend/               # Java Spring Boot Service
│   ├── src/main/java/     # Source code logic (SLIB Core)
│   ├── pom.xml            # Quản lý dependencies Maven
│   └── Dockerfile         # Cấu hình triển khai Docker
├── frontend/              # React/Vite Application
│   ├── src/               # Components, Hooks, Services
│   ├── public/            # Assets tĩnh
│   └── package.json       # Quản lý thư viện Node.js
└── README.md              # Tài liệu hướng dẫn này# 🚀 SLIB - Smart Library Management System
...
│   ├── public/            # Assets tĩnh
│   └── package.json       # Quản lý thư viện Node.js
└── README.md              # Tài liệu hướng dẫn này# SLIB Backend Service
...
© 2024 SLIB Team. All rights reserved.
# 🚀 SLIB - Smart Library Management System
