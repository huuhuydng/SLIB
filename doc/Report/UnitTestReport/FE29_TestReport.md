...
<table class="report-meta">
  <tr>  <td class="label">Function Code</td>  <td class="value italic">FE-29</td>  <td class="label">Function Name</td>  <td class="value link">View Seat Map</td></tr>
  ...
  <tr>  <td class="label">Class Under Test</td>  <td class="value code" colspan="3"><code>SeatService.getSeatsByZoneId(...) and BookingService.getSeatsByTime(...)</code></td></tr>
...
<table class="matrix-table">
  ...
  <tr><td class="category-cell" rowspan="1">API Endpoint</td><td class="item-cell">/slib/seats?zoneId={zoneId}</td><td class="mark-cell">O</td><td class="mark-cell">O</td><td class="mark-cell">O</td><td class="mark-cell">O</td><td class="mark-cell">O</td></tr>
  ...
  <tr><td class="item-cell">Invalid zoneId format</td><td class="mark-cell"></td><td class="mark-cell"></td><td class="mark-cell"></td><td class="mark-cell"></td><td class="mark-cell">O</td></tr>
  ...
  <tr><td class="category-cell" rowspan="5">Log message</td><td class="item-cell">Successfully retrieved Seat Map for Valid JWT Token</td><td class="mark-cell">O</td><td class="mark-cell"></td><td class="mark-cell"></td><td class="mark-cell"></td><td class="mark-cell"></td></tr>
  <tr><td class="item-cell">Failed to retrieve Seat Map: Unauthorized request for No token in request</td><td class="mark-cell"></td><td class="mark-cell">O</td><td class="mark-cell"></td><td class="mark-cell"></td><td class="mark-cell"></td></tr>
  <tr><td class="item-cell">Failed to retrieve Seat Map: Requested resource not found for Zone not found</td><td class="mark-cell"></td><td class="mark-cell"></td><td class="mark-cell">O</td><td class="mark-cell"></td><td class="mark-cell"></td></tr>
  <tr><td class="item-cell">Failed to retrieve Seat Map: User does not have permission for No permission</td><td class="mark-cell"></td><td class="mark-cell"></td><td class="mark-cell"></td><td class="mark-cell">O</td><td class="mark-cell"></td></tr>
  <tr><td class="item-cell">Failed to retrieve Seat Map: Invalid request parameters for Invalid zoneId format</td><td class="mark-cell"></td><td class="mark-cell"></td><td class="mark-cell"></td><td class="mark-cell"></td><td class="mark-cell">O</td></tr>
