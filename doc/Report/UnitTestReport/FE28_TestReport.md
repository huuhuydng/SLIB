# Unit Test Report - FE-28: Lock Zone Movement

<table class="report-meta">
  <tr>  <td class="label">Function Code</td>  <td class="value italic">FE-28</td>  <td class="label">Function Name</td>  <td class="value link">Lock Zone Movement</td></tr>
  ...
  <tr>  <td class="label">Class Under Test</td>  <td class="value code" colspan="3"><code>ZoneService.updateZone(...), updateZonePosition(...), updateZoneDimensions(...)</code></td></tr>
...
<table class="matrix-table">
  ...
  <tr><td class="item-cell">Zone exists</td><td class="mark-cell">O</td><td class="mark-cell"></td><td class="mark-cell"></td><td class="mark-cell">O</td><td class="mark-cell"></td></tr>
  ...
  <tr><td class="item-cell">Zone already locked</td><td class="mark-cell"></td><td class="mark-cell"></td><td class="mark-cell"></td><td class="mark-cell">O</td><td class="mark-cell"></td></tr>
  ...
  <tr><td class="item-cell">409: Conflict</td><td class="mark-cell"></td><td class="mark-cell"></td><td class="mark-cell"></td><td class="mark-cell">O</td><td class="mark-cell"></td></tr>
  ...
  <tr><td class="category-cell" rowspan="5">Log message</td><td class="item-cell">Successfully updated Lock Zone Movement for Valid JWT Token</td><td class="mark-cell">O</td><td class="mark-cell"></td><td class="mark-cell"></td><td class="mark-cell"></td><td class="mark-cell"></td></tr>
  <tr><td class="item-cell">Failed to update Lock Zone Movement: Unauthorized request for No token in request</td><td class="mark-cell"></td><td class="mark-cell">O</td><td class="mark-cell"></td><td class="mark-cell"></td><td class="mark-cell"></td></tr>
  <tr><td class="item-cell">Failed to update Lock Zone Movement: Requested resource not found for Zone not found</td><td class="mark-cell"></td><td class="mark-cell"></td><td class="mark-cell">O</td><td class="mark-cell"></td><td class="mark-cell"></td></tr>
  <tr><td class="item-cell">Failed to update Lock Zone Movement: Resource conflict for Zone already locked</td><td class="mark-cell"></td><td class="mark-cell"></td><td class="mark-cell"></td><td class="mark-cell">O</td><td class="mark-cell"></td></tr>
  <tr><td class="item-cell">Failed to update Lock Zone Movement: User does not have permission for Non-admin role</td><td class="mark-cell"></td><td class="mark-cell"></td><td class="mark-cell"></td><td class="mark-cell"></td><td class="mark-cell">O</td></tr>
