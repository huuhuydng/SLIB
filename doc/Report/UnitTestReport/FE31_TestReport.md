# Unit Test Report - FE-31: Change Seat Status

<table class="report-meta">
  <tr>  <td class="label">Function Code</td>  <td class="value italic">FE-31</td>  <td class="label">Function Name</td>  <td class="value link">Change Seat Status</td></tr>
  ...
  <tr>  <td class="label">Class Under Test</td>  <td class="value code" colspan="3"><code>SeatService.restrictSeatById(Integer seatId) and unrestrictSeatById(Integer seatId)</code></td></tr>
...
<table class="matrix-table">
  ...
  <tr><td class="section-cell" rowspan="11">Condition</td><td class="category-cell" rowspan="3">Precondition</td><td class="item-cell">Authorized</td><td class="mark-cell">O</td><td class="mark-cell"></td><td class="mark-cell">O</td><td class="mark-cell"></td><td class="mark-cell">O</td></tr>
  <tr><td class="item-cell">Role = ADMIN</td><td class="mark-cell">O</td><td class="mark-cell"></td><td class="mark-cell"></td><td class="mark-cell"></td><td class="mark-cell"></td></tr>
  <tr><td class="item-cell">Seat exists</td><td class="mark-cell">O</td><td class="mark-cell"></td><td class="mark-cell"></td><td class="mark-cell">O</td><td class="mark-cell"></td></tr>
  ...
  <tr><td class="category-cell" rowspan="1">API Endpoint</td><td class="item-cell">/slib/seats/{seatId}/restrict</td><td class="mark-cell">O</td><td class="mark-cell">O</td><td class="mark-cell">O</td><td class="mark-cell">O</td><td class="mark-cell">O</td></tr>
  ...
  <tr><td class="item-cell">Invalid status value</td><td class="mark-cell"></td><td class="mark-cell"></td><td class="mark-cell">O</td><td class="mark-cell"></td><td class="mark-cell"></td></tr>
  <tr><td class="item-cell">Seat not found</td><td class="mark-cell"></td><td class="mark-cell"></td><td class="mark-cell"></td><td class="mark-cell">O</td><td class="mark-cell"></td></tr>
  ...
  <tr><td class="item-cell">400: Bad Request</td><td class="mark-cell"></td><td class="mark-cell"></td><td class="mark-cell">O</td><td class="mark-cell"></td><td class="mark-cell"></td></tr>
  ...
  <tr><td class="category-cell" rowspan="5">Log message</td><td class="item-cell">Successfully created Change Seat Status for Valid JWT Token</td><td class="mark-cell">O</td><td class="mark-cell"></td><td class="mark-cell"></td><td class="mark-cell"></td><td class="mark-cell"></td></tr>
  <tr><td class="item-cell">Failed to create Change Seat Status: Unauthorized request for No token in request</td><td class="mark-cell"></td><td class="mark-cell">O</td><td class="mark-cell"></td><td class="mark-cell"></td><td class="mark-cell"></td></tr>
  <tr><td class="item-cell">Failed to create Change Seat Status: Invalid request parameters for Invalid status value</td><td class="mark-cell"></td><td class="mark-cell"></td><td class="mark-cell">O</td><td class="mark-cell"></td><td class="mark-cell"></td></tr>
  <tr><td class="item-cell">Failed to create Change Seat Status: Requested resource not found for Seat not found</td><td class="mark-cell"></td><td class="mark-cell"></td><td class="mark-cell"></td><td class="mark-cell">O</td><td class="mark-cell"></td></tr>
  <tr><td class="item-cell">Failed to create Change Seat Status: User does not have permission for Non-admin role</td><td class="mark-cell"></td><td class="mark-cell"></td><td class="mark-cell"></td><td class="mark-cell"></td><td class="mark-cell">O</td></tr>
