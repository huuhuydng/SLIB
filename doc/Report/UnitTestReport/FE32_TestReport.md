...
<table class="report-meta">
  <tr>  <td class="label">Function Code</td>  <td class="value italic">FE-32</td>  <td class="label">Function Name</td>  <td class="value link">View Reputation Rules</td></tr>
  ...
  <tr>  <td class="label">Class Under Test</td>  <td class="value code" colspan="3"><code>`ReputationRuleController.getAllRules()`, `ReputationRuleController.getRuleById(Integer id)`</code></td></tr>
...
<table class="matrix-table">
  ...
  <tr><td class="section-cell" rowspan="9">Condition</td><td class="category-cell" rowspan="1">Precondition</td><td class="item-cell">Authorized</td><td class="mark-cell">O</td><td class="mark-cell"></td><td class="mark-cell">O</td><td class="mark-cell"></td><td class="mark-cell">O</td></tr>
  ...
  <tr><td class="category-cell" rowspan="1">API Endpoint</td><td class="item-cell">/slib/reputation/rules</td><td class="mark-cell">O</td><td class="mark-cell">O</td><td class="mark-cell">O</td><td class="mark-cell">O</td><td class="mark-cell">O</td></tr>
  ...
  <tr><td class="item-cell">Valid JWT Token, no permission</td><td class="mark-cell"></td><td class="mark-cell"></td><td class="mark-cell">O</td><td class="mark-cell"></td><td class="mark-cell"></td></tr>
  <tr><td class="item-cell">Reputation rules not found</td><td class="mark-cell"></td><td class="mark-cell"></td><td class="mark-cell"></td><td class="mark-cell">O</td><td class="mark-cell"></td></tr>
  <tr><td class="item-cell">Invalid response format</td><td class="mark-cell"></td><td class="mark-cell"></td><td class="mark-cell"></td><td class="mark-cell"></td><td class="mark-cell">O</td></tr>
  ...
  <tr><td class="category-cell" rowspan="5">Log message</td><td class="item-cell">Successfully retrieved Reputation Rules for Valid JWT Token</td><td class="mark-cell">O</td><td class="mark-cell"></td><td class="mark-cell"></td><td class="mark-cell"></td><td class="mark-cell"></td></tr>
  <tr><td class="item-cell">Failed to retrieve Reputation Rules: Unauthorized request for No token in request</td><td class="mark-cell"></td><td class="mark-cell">O</td><td class="mark-cell"></td><td class="mark-cell"></td><td class="mark-cell"></td></tr>
  <tr><td class="item-cell">Failed to retrieve Reputation Rules: User does not have permission for Valid JWT Token, no permission</td><td class="mark-cell"></td><td class="mark-cell"></td><td class="mark-cell">O</td><td class="mark-cell"></td><td class="mark-cell"></td></tr>
  <tr><td class="item-cell">Failed to retrieve Reputation Rules: Requested resource not found for Reputation rules not found</td><td class="mark-cell"></td><td class="mark-cell"></td><td class="mark-cell"></td><td class="mark-cell">O</td><td class="mark-cell"></td></tr>
  <tr><td class="item-cell">Failed to retrieve Reputation Rules: Unexpected system error for Invalid response format</td><td class="mark-cell"></td><td class="mark-cell"></td><td class="mark-cell"></td><td class="mark-cell"></td><td class="mark-cell">O</td></tr>
