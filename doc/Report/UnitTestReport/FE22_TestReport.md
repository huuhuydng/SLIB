...
<table class="report-meta">
  <tr>  <td class="label">Function Code</td>  <td class="value italic">FE-22</td>  <td class="label">Function Name</td>  <td class="value link">Change Area Status</td></tr>
  ...
  <tr>  <td class="label">Class Under Test</td>  <td class="value code" colspan="3"><code>AreaService.updateAreaIsActive(Long id, AreaResponse req)</code></td></tr>
...
<table class="matrix-table">
  ...
  <tr><td class="section-cell" rowspan="11">Condition</td><td class="category-cell" rowspan="3">Precondition</td><td class="item-cell">Authorized</td><td class="mark-cell">O</td><td class="mark-cell"></td><td class="mark-cell">O</td><td class="mark-cell">O</td><td class="mark-cell">O</td></tr>
  ...
  <tr><td class="item-cell">Area exists</td><td class="mark-cell">O</td><td class="mark-cell"></td><td class="mark-cell"></td><td class="mark-cell">O</td><td class="mark-cell">O</td></tr>
  ...
  <tr><td class="category-cell" rowspan="1">API Endpoint</td><td class="item-cell">/slib/areas/{id}/active</td><td class="mark-cell">O</td><td class="mark-cell">O</td><td class="mark-cell">O</td><td class="mark-cell">O</td><td class="mark-cell">O</td></tr>
  ...
  <tr><td class="item-cell">isActive: true</td><td class="mark-cell">O</td><td class="mark-cell">O</td><td class="mark-cell"></td><td class="mark-cell"></td><td class="mark-cell">O</td></tr>
  ...
  <tr><td class="item-cell">Area not found</td><td class="mark-cell"></td><td class="mark-cell"></td><td class="mark-cell">O</td><td class="mark-cell"></td><td class="mark-cell"></td></tr>
  <tr><td class="item-cell">isActive: 3</td><td class="mark-cell"></td><td class="mark-cell"></td><td class="mark-cell"></td><td class="mark-cell">O</td><td class="mark-cell"></td></tr>
  ...
  <tr><td class="category-cell" rowspan="5">Log message</td><td class="item-cell">Successfully updated Change Area Status for Valid JWT Token</td><td class="mark-cell">O</td><td class="mark-cell"></td><td class="mark-cell"></td><td class="mark-cell"></td><td class="mark-cell"></td></tr>
  <tr><td class="item-cell">Failed to update Change Area Status: Unauthorized request for isActive: true</td><td class="mark-cell"></td><td class="mark-cell">O</td><td class="mark-cell"></td><td class="mark-cell"></td><td class="mark-cell"></td></tr>
  <tr><td class="item-cell">Failed to update Change Area Status: Requested resource not found for Valid JWT Token</td><td class="mark-cell"></td><td class="mark-cell"></td><td class="mark-cell">O</td><td class="mark-cell"></td><td class="mark-cell"></td></tr>
  <tr><td class="item-cell">Failed to update Change Area Status: Invalid request parameters for Valid JWT Token</td><td class="mark-cell"></td><td class="mark-cell"></td><td class="mark-cell"></td><td class="mark-cell">O</td><td class="mark-cell"></td></tr>
  <tr><td class="item-cell">Failed to update Change Area Status: User does not have permission for Valid JWT Token</td><td class="mark-cell"></td><td class="mark-cell"></td><td class="mark-cell"></td><td class="mark-cell"></td><td class="mark-cell">O</td></tr>
