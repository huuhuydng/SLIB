# Test Report - FE-36: Configure Booking Rules
...
|-----------|---------|
| **Function Code** | FE-36 |
| **Function Name** | Configure Booking Rules |
| **Created By** | |
| **Executed By** | |
| **Lines of code** | ~20 |
...
| POST/PUT | ⚪ | ⚪ | ⚪ | ⚪ | ⚪ |
| **API Endpoint** | | | | | |
| /slib/settings/booking-rules | ⚪ | ⚪ | ⚪ | ⚪ | ⚪ |
| **Input** | | | | | |
| Valid JWT Token | ⚪ | | | | |
| No token in request | | ⚪ | | | |
| Valid non-admin JWT Token | | | ⚪ | | |
| Valid JWT Token + invalid rules | | | | ⚪ | |
| Non-admin role | | | | | ⚪ |
| **CONFIRM** | | | | | |
| **Return** | | | | | |
| 200: OK | ⚪ | | | | |
...
| RuntimeException | | ⚪ | ⚪ | | ⚪ |
| **Log message** | | | | | |
| "Booking rules configured successfully" | ⚪ | | | | |
| "No token provided" | | ⚪ | | | |
| "Access denied" | | | ⚪ | | ⚪ |
| "Invalid booking rules" | | | | ⚪ | |
| **RESULT** | | | | | |
