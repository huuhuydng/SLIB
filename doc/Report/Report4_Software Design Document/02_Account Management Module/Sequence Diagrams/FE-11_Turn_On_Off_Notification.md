...
sequenceDiagram
    ...
    Users->>Client: 1. Toggle the notification setting
    activate Users
    activate Client

    alt 2a. User turns notification on
        Client->>Client: 2a.1 Set isBookingRemindEnabled = true in UI state
    else 2b. User turns notification off
        Client->>Client: 2b.1 Set isBookingRemindEnabled = false in UI state
    end
    ...
    Client->>UserSettingController: 5. PUT /slib/settings/{userId} with isBookingRemindEnabled
    deactivate Client
    ...
    UserSettingService->>UserSettingService: 10. Apply new notification preference
    ...
    alt 13a. Server synchronization succeeds
        ...
        deactivate UserSettingController
        activate Client
        Client-->>Users: 13a.2 Keep notification switch in the new state
